    ...
    return(
        ...
        <body class="home">
            <header class={`primary-header flex ${showLinks ? "show-nav" : "hide-nav"}`}>
                <div class='ff-LOGO'>
                    <a href='/'><strong>elane</strong>_photography</a>
                {/* <Link to="/" onClick={closeMobileMenu}>elane_photography</Link> */}
                </div>
                ...
                <nav>
                    ...
                    <ul className='primary-navigation flex'>
                        <li class='slideInDown1'>
                            <a class='ff-source-code-pro-monospace' href='/elane_photography'>
